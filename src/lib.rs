...
//! [`word_filter::codegen`](https://docs.rs/word_filter::codegen) crate. The generated code can then
...
/// [`word_filter::codegen`](https://docs.rs/word_filter::codegen) crate. See crate-level
