...
fn main() {
    ...
    writeln!(
        ...
        bar_generator
            ...
            .generate("MERGED_ALIASES"),
        base_generator
            .clone()
            .word("ahj")
            .aliases(&[("a", "bc"), ("cdef", "g"), ("h", "de"), ("j", "fi")])
            .generate("MERGED_ALIASES_CONTIGUOUS"),
        bar_generator
            .clone()
            .aliases(&[("b", "x"), ("a", "y"), ("r", "z"), ("xyz", "w")])
            .generate("MERGED_ALIASES_OVER_FULL_MATCH"),
        bar_generator
            .clone()
            .aliases(&[('a', 'b'), ('b', 'a')])
            .generate("RECURSIVE_ALIASES"),
        foo_generator
            .clone()
            .word("bar")
            .alias('a', 'A')
            .generate("MULTIPLE_WORDS_AND_ALIAS"),
        bar_generator
            .clone()
            .separator(' ')
            .alias('a', 'A')
            .generate("SEPARATOR_AND_ALIAS"),
        bar_generator
            .clone()
            .word("foobar")
            .separator(' ')
            .alias("bar", "baz")
            .generate("WORD_IN_WORD_WITH_SEPARATOR_AND_ALIAS"),
        grapheme_generator.generate("GRAPHEME"),
        bar_generator
            .clone()
            .alias('a', "ã")
            .generate("GRAPHEME_IN_ALIAS"),
        grapheme_generator
            .clone()
            .alias("ã", "õ")
            .generate("ALIAS_ON_GRAPHEME"),
        base_generator
            .clone()
            .word("ãbc")
